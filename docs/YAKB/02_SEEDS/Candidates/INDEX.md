...
| CAND-EXP-004 | `CAND-EXP-004_DreamTown_One_Year_Companion_Lifecycle.md` | Experience / Framework | Candidate | DreamTown Experience Framework / DreamTown Companion SSOT / K-Wisdom Module | DreamTown 1년 동행 시스템 — 아침 밥상 + 저녁 9시 안부 Daily Companion Loop, 1년 6단계 감정 성장, DreamTown Leader 정의, 회복 경험의 K-지혜 전환 루프. **신규 EXP 카테고리 계열 시작. EXP-001~003 선행 번호 미확인.** **(브랜치 `feature/checkin-mvp`)** |
| CAND-OPS-008 | `CAND-OPS-008_Insight_Capture_Framework.md` | Operations / Framework | Candidate | SSOT-KNOWLEDGE-004 / Phoenix Operations SSOT | 운영 중 발견한 통찰을 독립 Knowledge Asset으로 축적하는 프레임워크. Insight Capture Trigger 5종, Experience→Insight Note→Evidence→Candidate→SSOT 라이프사이클. "가치가 소멸하고 있는 거야" 문제의식에서 도출. **⚠️ 제안 ID OPS-005 → OPS-005 기존 점유로 OPS-008 재배정.** **(브랜치 `feature/checkin-mvp`)** |
| CAND-FRW-004 | `CAND-FRW-004_Dream_Miracle_Experience_Hierarchy.md` | Framework / Experience Architecture | **Candidate** | `SSOT-FRW-001_Dream_Miracle_Framework.md` (신규 제안) | Dream(경험 세계)–Miracle(경험 조각)–Miracle MVP(Life OS) 3계층 통합 프레임워크. Project Phoenix 전체 서비스(DreamTown/Shop/Learn/Festival/Volunteer)를 하나의 성장 구조로 통합. 콘텐츠 명명 7종·DreamTown 정의·Platform Philosophy 포함. Impact 98/100. **신규 FRW 카테고리 계열 시작.** **(브랜치 `feature/checkin-mvp`, 2026-08-03)** |
